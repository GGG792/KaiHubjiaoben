...
Tabs.Tab:Button({Title="砍伐树木",Desc="砍伐树木",Callback=function()
	...
	local Window = WindUI:CreateWindow({Title="<font color='#FF0000'>Xcellent Efficiency </font>Hub",Author="Produced by Xcellent Efficiency Studio",Folder="CloudHub",Size=UDim2.fromOffset(200, 395),Transparent=true,Theme="Dark",User={Enabled=false,Callback=function()
		print("clicked");
	...
	Window:EditOpenButton({Title="<font color='#FF0000'>Xcellent Efficiency </font>Hub",CornerRadius=UDim.new(0, 10),StrokeThickness=2.5,Color=ColorSequence.new(Color3.fromHex("#874da2"), Color3.fromHex("#c43a30")),Draggable=true});
	TabSection = Window:Section({Title="砍伐树木",Opened=true});
	local Tab = TabSection:Tab({Title="主要功能",Icon="check"});
	local kan = false;
	Tab:Toggle({Title="范围砍树(可能会卡)",Default=false,Image="check",Callback=function(state)
