...
A:Toggle({Title="AFK(必开)",Value=false,Callback=function(state)
	if state then
		bypassCount = 0;
...
A:Toggle({Title="自动举哑铃",Default=false,Callback=function(state)
...
A:Toggle({Title="自动俯卧撑",Default=false,Callback=function(state)
...
A:Toggle({Title="自动仰卧起坐",Default=false,Callback=function(state)
...
A:Toggle({Title="自动倒立",Default=false,Callback=function(state)
...
local rockNames = {["Tiny Rock"]="小石头",["Inferno Rock"]="地狱石头",["Punching Rock"]="拳击石头",["Rock Of Legends"]="传奇石头",["Muscle King Mountain"]="肌肉王石头",["Ancient Jungle Rock"]="丛林石头"};
local AutoStates = {rock=false,rocks=false,RK0=false,RK10=false,RK100=false,RK5000=false,RK150000=false,RK400000=false,RK750000=false,RK1M=false,RK5M=false,JungleRock10M=false};
B:Dropdown({Title="选择石头",Values=rockshow1,Value="空",Callback=function(Value)
...
local rockNames2 = {["Tiny Rock"]="小石头",["Inferno Rock"]="地狱石头",["Punching Rock"]="拳击石头",["Rock Of Legends"]="传奇石头",["Muscle King Mountain"]="肌肉王石头",["Ancient Jungle Rock"]="丛林石头"};
B:Dropdown({Title="选择石头",Values=rockshow2,Value="空",Callback=function(Value)
...
B:Toggle({Title="石头0",Default=false,Callback=function(state)
	getgenv().RK0 = state;
	spawn(function()
		while getgenv().RK0 do
			...
			pcall(function()
				...
				game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(7.60643005, 4.02632904, 2104.54004, -0.23040159, -8.536623852251068E-08, -0.973095655, -4.687437638040137E-08, 1, -7.662793422014147E-08, 0.973095655, 2.795805364996795E-08, -0.23040159);
			end);
		end
...
B:Toggle({Title="石头10",Default=false,Callback=function(state)
	getgenv().RK10 = state;
	spawn(function()
		if (game.Players.LocalPlayer.Durability.Value >= 10) then
			while getgenv().RK10 do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-157.680908, 3.72453046, 434.871185, 0.923298299, -1.817746841936696E-09, -0.384083599, 3.452470309639466E-09, 1, 3.5667058195798518E-09, 0.384083599, -4.619170823616514E-09, 0.923298299);
				end);
			end
		end
...
B:Toggle({Title="石头100",Default=false,Callback=function(state)
	getgenv().RK100 = state;
	spawn(function()
		if (game.Players.LocalPlayer.Durability.Value >= 100) then
			while getgenv().RK100 do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(162.233673, 3.66615629, -164.686783, -0.921312928, -1.808267739988878E-07, -0.38882193, -9.130365441478716E-08, 1, -2.487193455635861E-07, 0.38882193, -1.9364749448413932E-07, -0.921312928);
				end);
			end
		end
...
B:Toggle({Title="石头5000",Default=false,Callback=function(state)
		...
		if (game.Players.LocalPlayer.Durability.Value >= 5000) then
			while getgenv().RK5000 do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(329.831482, 3.66450214, -618.48407, -0.806075394, -8.673580964568828E-08, 0.591812849, -1.057155216699357E-07, 1, 2.57029175720902E-09, -0.591812849, -6.049195633295312E-08, -0.806075394);
				end);
			end
		end
...
B:Toggle({Title="石头150000",Default=false,Callback=function(state)
		...
		if (game.Players.LocalPlayer.Durability.Value >= 150000) then
			while getgenv().RK150000 do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-2566.78076, 3.97019577, -277.503235, -0.923934579, -4.116001051102103E-08, -0.382550538, -3.3883804206880086E-08, 1, -2.5757618260513482E-08, 0.382550538, -1.0836085806431583E-08, -0.923934579);
				end);
			end
		end
...
B:Toggle({Title="石头400000",Default=false,Callback=function(state)
		...
		if (game.Players.LocalPlayer.Durability.Value >= 400000) then
			while getgenv().RK400000 do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(2155.61743, 3.79830337, 1227.06482, -0.551303148, -9.167969494683348E-09, -0.834304988, -5.613182452179899E-08, 1, 2.6102783934334184E-08, 0.834304988, 6.122161266830517E-08, -0.551303148);
				end);
			end
		end
...
B:Toggle({Title="石头750000",Default=false,Callback=function(state)
		...
		if (game.Players.LocalPlayer.Durability.Value >= 750000) then
			while getgenv().RK750000 do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-7285.6499, 3.66624784, -1228.27417, 0.857643783, -1.581750908030699E-08, -0.514244199, -1.2258156267819231E-08, 1, -5.120259771729252E-08, 0.514244199, 5.021727744747295E-08, 0.857643783);
				end);
			end
		end
...
B:Toggle({Title="石头100万",Default=false,Callback=function(state)
	getgenv().RK1M = state;
	spawn(function()
		if (game.Players.LocalPlayer.Durability.Value >= 1000000) then
			while getgenv().RK1M do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(4160.87109, 987.829102, -4136.64502, -0.893115997, 1.2548135600809474E-05, 0.44982639, 5.024906840844778E-06, 1, -1.7918713638209738E-05, -0.44982639, -1.374315434077289E-05, -0.893115997);
				end);
			end
		end
...
B:Toggle({Title="石头500万",Default=false,Callback=function(state)
	getgenv().RK5M = state;
	spawn(function()
		if (game.Players.LocalPlayer.Durability.Value >= 5000000) then
			while getgenv().RK5M do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-8957.54395, 5.53625107, -6126.90186, -0.803919137, 6.606521196772519E-08, 0.594738603, -8.931361428210494E-09, 1, -1.2315545916408155E-07, -0.594738603, -1.0431886465767093E-07, -0.803919137);
				end);
			end
		end
...
B:Toggle({Title="石头1000万",Default=false,Callback=function(state)
		...
		if (game.Players.LocalPlayer.Durability.Value >= 10000000) then
			while getgenv().JungleRock10M do
				...
				pcall(function()
					...
					game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-7552.9, 3.4, 2847.7, -0.803919137, 6.606521196772519E-08, 0.594738603, -8.931361428210494E-09, 1, -1.2315545916408155E-07, -0.594738603, -1.0431886465767093E-07, -0.803919137);
				end);
			end
		end
...
if not _G.WindUI_AutoStates then
	_G.WindUI_AutoStates = {AutoKillReport=false,AutoKillReport2=false,AutoKillReport3=false,AutoKillReport4=false,AutoKill=false,killall=false};
end
...
C:Toggle({Title="自动刷业报v2",Default=AutoStates.AutoKillReport2,Callback=function(state)
	...
	local sP = CFrame.new(-8751, 120.4, -5863.1, 0.59992, -2.239999963293826E-09, 0.80006, 4.459999924932845E-09, 1, -5.440000117040711E-10, -0.80006, 3.899999878598237E-09, 0.59992);
	local function tS()
		local c = game.Players.LocalPlayer.Character;
...
local function refreshPlayerList()
	...
	if killplayerDropdown then
		...
		WindUI:Notify({Title="玩家列表",Content=("玩家列表已刷新 (" .. #PlayerList .. " 个玩家)"),Duration=3});
	end
end
...
initializePlayerList();
local killplayerDropdown = C:Dropdown({Title="要远程的玩家",Values=PlayerList,Value={},Multi=true,AllowNone=true,Callback=function(values)
	Interstellar.killplayers = values or {};
	WindUI:Notify({Title="远程",Content=("已设置 " .. #Interstellar.killplayers .. " 个玩家为远程目标"),Duration=3});
end});
...
C:Button({Title="刷新玩家列表",Callback=function()
	refreshPlayerList();
	WindUI:Notify({Title="玩家列表",Content="刷新玩家列表成功",Duration=3});
end});
local equipmentSection = D:Section({Title="跑步机",Opened=true});
D:Toggle({Title="沙滩跑步机10",Default=false,Callback=function(state)
	getgenv().PPJ10 = state;
	while getgenv().PPJ10 do
		...
		rootPart.CFrame = CFrame.new(238.671112, 5.40315914, 387.713165, -0.0160072874, -2.9071017593196302E-08, -0.99987185, -3.34341909713487E-09, 1, -2.9021215652846877E-08, 0.99987185, 2.8784399308534603E-09, -0.0160072874);
...
D:Toggle({Title="冰霜健身房跑步机2000",Default=false,Callback=function(state)
	if (game.Players.LocalPlayer.Agility.Value >= 2000) then
		...
		while getgenv().PPJ2000 do
			...
			local rootPart = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart");
			humanoid.WalkSpeed = 10;
			rootPart.CFrame = CFrame.new(-3005.37866, 14.3221855, -464.697876, -0.015773816, -1.3850896429801196E-08, 0.999875605, -5.13225586473709E-08, 1, 1.3042966706677817E-08, -0.999875605, -5.111043321903708E-08, -0.015773816);
			local RunService = game:GetService("RunService");
			local Players = game:GetService("Players");
			local localPlayer = Players.LocalPlayer;
			RunService:BindToRenderStep("move", Enum.RenderPriority.Character.Value + 1, function()
...
D:Toggle({Title="神话健身房跑步机2000",Default=false,Callback=function(state)
	if (game.Players.LocalPlayer.Agility.Value >= 2000) then
		...
		while getgenv().SHPPJ2000 do
			...
			local rootPart = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart");
			humanoid.WalkSpeed = 10;
			rootPart.CFrame = CFrame.new(2571.23706, 15.6896839, 898.650391, 0.999968231, 2.2386863474110896E-09, -0.00797206629, -1.731988441555643E-09, 1, 6.356607684665505E-08, 0.00797206629, -6.355024595450232E-08, 0.999968231);
			local RunService = game:GetService("RunService");
			local Players = game:GetService("Players");
			local localPlayer = Players.LocalPlayer;
			RunService:BindToRenderStep("move", Enum.RenderPriority.Character.Value + 1, function()
...
D:Toggle({Title="永恒健身房跑步机3500",Default=false,Callback=function(state)
	if (game.Players.LocalPlayer.Agility.Value >= 3500) then
		...
		while getgenv().YHPPJ3500 do
			...
			local rootPart = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart");
			humanoid.WalkSpeed = 10;
			rootPart.CFrame = CFrame.new(-7077.79102, 29.6702118, -1457.59961, -0.0322036594, -3.3112276809355023E-10, 0.99948132, -6.443442668313537E-09, 1, 1.2368449320288022E-10, -0.99948132, -6.43611741679706E-09, -0.0322036594);
			local RunService = game:GetService("RunService");
			local Players = game:GetService("Players");
			local localPlayer = Players.LocalPlayer;
			RunService:BindToRenderStep("move", Enum.RenderPriority.Character.Value + 1, function()
...
D:Toggle({Title="传奇健身房跑步机3000",Default=false,Callback=function(state)
	if (game.Players.LocalPlayer.Agility.Value >= 3000) then
		...
		while getgenv().CQPPJ3000 do
			...
			local rootPart = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart");
			humanoid.WalkSpeed = 10;
			rootPart.CFrame = CFrame.new(4370.82812, 999.358704, -3621.42773, -0.960604727, -8.419492658617855E-09, -0.27791819, -6.124786455785625E-09, 1, -9.124965671958307E-09, 0.27791819, -7.063295281994897E-09, -0.960604727);
			local RunService = game:GetService("RunService");
			local Players = game:GetService("Players");
			local localPlayer = Players.LocalPlayer;
			RunService:BindToRenderStep("move", Enum.RenderPriority.Character.Value + 1, function()
...
D:Toggle({Title="丛林健身房跑步机20000",Default=false,Callback=function(state)
	if (game.Players.LocalPlayer.Agility.Value >= 20000) then
		...
		while getgenv().JungleTreadmill do
			...
			local rootPart = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart");
			humanoid.WalkSpeed = 10;
			rootPart.CFrame = CFrame.new(-8138.67919921875, 28.270538330078125, 2833.511474609375, -0.960604727, -8.419492658617855E-09, -0.27791819, -6.124786455785625E-09, 1, -9.124965671958307E-09, 0.27791819, -7.063295281994897E-09, -0.960604727);
			local RunService = game:GetService("RunService");
			local Players = game:GetService("Players");
			local localPlayer = Players.LocalPlayer;
...
D:Toggle({Title="沙滩深蹲架",Default=false,Callback=function(state)
...
D:Toggle({Title="霜冻健身房深蹲架",Default=false,Callback=function(state)
...
D:Toggle({Title="传奇健身房深蹲架",Default=false,Callback=function(state)
...
D:Toggle({Title="肌肉之王健身房深蹲架",Default=false,Callback=function(state)
...
D:Toggle({Title="丛林健身房深蹲架",Default=false,Callback=function(state)
...
D:Toggle({Title="沙滩引体向上",Default=false,Callback=function(state)
...
D:Toggle({Title="神话健身房引体向上",Default=false,Callback=function(state)
...
D:Toggle({Title="沙滩投掷石",Default=false,Callback=function(state)
			...
			while getgenv().ThrowBeach do
				pcall(function()
					if (game.Players.LocalPlayer.leaderstats.Strength.Value >= 3000) then
						if (game.Players.LocalPlayer.machineInUse.Value == nil) then
							game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-91.6730804, 3.67689133, -292.42868, -0.221022144, -2.2104162056280074E-08, -0.975268781, 1.2141440741686438E-08, 1, -2.5416264648470133E-08, 0.975268781, -1.7458726020436188E-08, -0.221022144);
							wait(0.0001);
							local vim = game:GetService("VirtualInputManager");
							vim:SendKeyEvent(true, "E", false, game);
							wait(0.0001);
...
D:Toggle({Title="神话健身房投掷石",Default=false,Callback=function(state)
			...
			while getgenv().ThrowMythGym do
				pcall(function()
					if (game.Players.LocalPlayer.leaderstats.Strength.Value >= 10000) then
						if (game.Players.LocalPlayer.machineInUse.Value == nil) then
							game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(2486.01733, 3.67689276, 1237.89331, 0.883595645, -2.0613503792787924E-08, -0.468250751, -3.3286871037319088E-09, 1, -5.0303640364290914E-08, 0.468250751, 4.600673619847839E-08, 0.883595645);
							wait(0.0001);
							local vim = game:GetService("VirtualInputManager");
							vim:SendKeyEvent(true, "E", false, game);
							wait(0.0001);
...
D:Toggle({Title="传奇健身房投掷石",Default=false,Callback=function(state)
...
D:Toggle({Title="肌肉之王投掷石",Default=false,Callback=function(state)
...
D:Toggle({Title="丛林健身房投掷石",Default=false,Callback=function(state)
	...
	if getgenv().ThrowJungleGym then
		spawn(function()
			while getgenv().ThrowJungleGym do
				pcall(function()
					if (game.Players.LocalPlayer.machineInUse.Value == nil) then
						game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(-8620.99, 89.81, 2673.54, -0.902269304, 1.6361029864242482E-08, -0.431172907, 1.7107648631053962E-08, 1, 2.146062882957267E-09, 0.431172907, -5.440027539549419E-09, -0.902269304);
						wait(0.0001);
						local vim = game:GetService("VirtualInputManager");
						vim:SendKeyEvent(true, "E", false, game);
						wait(0.0001);
...
E:Input({Title="自定义重生次数",Desc="只能输入大于现在的重生次数",Callback=function(value)
...
G:Button({Title="安全点",Callback=function()
	T(CFrame.new(-51.67, 32.22, 1290.41, 0.99455, 1.240000013780218E-08, -0.10422, -7.589999739820996E-09, 1, 4.620000026989146E-08, 0.10422, -4.520000018715109E-08, 0.99455));
end});
	...
	spawn(function()
		while getgenv().SafeSpot2 do
			...
			pcall(function()
				...
				char.HumanoidRootPart.CFrame = CFrame.new(-51.67, 32.22, 1290.41, 0.99455, 1.240000013780218E-08, -0.10422, -7.589999739820996E-09, 1, 4.620000026989146E-08, 0.10422, -4.520000018715109E-08, 0.99455);
			end);
		end
	end);
end});
...
G:Button({Title="雕像头顶",Callback=function()
	T(CFrame.new(1.19, 85.09, 244.49, 0.59992, -2.239999963293826E-09, 0.80006, 4.459999924932845E-09, 1, -5.440000117040711E-10, -0.80006, 3.899999878598237E-09, 0.59992));
end});
G:Button({Title="肌肉王雕像头顶",Callback=function()
	T(CFrame.new(-8751, 120.4, -5863.1, 0.59992, -2.239999963293826E-09, 0.80006, 4.459999924932845E-09, 1, -5.440000117040711E-10, -0.80006, 3.899999878598237E-09, 0.59992));
end});
G:Button({Title="出生点",Callback=function()
	T(CFrame.new(7, 3, 108));
end});
G:Button({Title="新手岛",Callback=function()
	T(CFrame.new(-37.61, 4.16, 1877.14));
end});
G:Button({Title="传说健身房",Callback=function()
	T(CFrame.new(4603.28, 988.18, -3897.87));
end});
G:Button({Title="永恒健身房",Callback=function()
	T(CFrame.new(-6758.96, 4.01, -1284.92));
end});
G:Button({Title="神话健身房",Callback=function()
	T(CFrame.new(2250.78, 4.01, 1073.23));
end});
G:Button({Title="冰霜健身房",Callback=function()
	T(CFrame.new(-2623.02, 4.01, -409.07));
end});
G:Button({Title="肌肉之王健身房",Callback=function()
	T(CFrame.new(-8625.93, 13.86, -5730.47));
end});
G:Button({Title="丛林健身房",Callback=function()
...
H:Divider();
H:Button({Title="使用一次蛋白质蛋",Callback=function()
	local c = game.Players.LocalPlayer.Character;
	if not c then
		return;
	end
...
H:Button({Title="使用一次热带摇晃",Callback=function()
	local c = game.Players.LocalPlayer.Character;
	if not c then
		return;
	end
...
local Interstellar = {BuyAuto=false,BuyDark=false,BuyMuscle=false,BuyNeon=false,EvolveAuto=false,EvolveDark=false,EvolveMuscle=false,EvolveNeon=false,EvolveNeonCN=false,BlueCrystal=false,GreenCrystal=false,FrostCrystal=false,MythicalCrystal=false,InfernoCrystal=false,LegendsCrystal=false,MuscleElite=false,GalaxyOracle=false,JungleCrystal=false,AutoOpen=false};
local BuyPetShop, EvolvePet, OpenCrystal = "", "", "";
local petshow = {"肌肉王光环","暗星","霓虹卫报","赛博对决龙"};
local petNames = {["肌肉王光环"]="Muscle King",["暗星"]="Darkstar Hunter",["霓虹卫报"]="Neon Guardian",["赛博对决龙"]="Cybernetic Showdown Dragon"};
...
local crystalNames = {["蓝色宠物蛋"]="Blue Crystal",["绿色宠物蛋"]="Green Crystal",["冰霜宠物蛋"]="Frost Crystal",["神话宠物蛋"]="Mythical Crystal",["地狱宠物蛋"]="Inferno Crystal",["传奇宠物蛋"]="Legends Crystal",["传奇宠物蛋"]="Muscle Elite Crystal",["肌肉王宠物蛋"]="Galaxy Oracle Crystal",["丛林宠物蛋"]="Jungle Crystal"};
...
I:Dropdown({Title="选择购买的宠物",Values=petshow,Value="空",Callback=function(v)
	BuyPetShop = petNames[v];
end});
I:Button({Title="购买选中宠物一次",Callback=function()
	if BuyPetShop then
...
I:Toggle({Title="自动进化赛博对决龙",Default=false,Callback=function(s)
...
I:Toggle({Title="自动进化暗星",Default=false,Callback=function(s)
	Interstellar.EvolveDark = s;
	if s then
		spawn(function()
			while Interstellar.EvolveDark do
...
I:Toggle({Title="自动进化肌肉王光环",Default=false,Callback=function(state)
...
I:Toggle({Title="自动进化霓虹卫报",Default=false,Callback=function(s)
...
I:Dropdown({Title="选择宠物蛋",Values=crystalshow,Value="空",Callback=function(v)
	OpenCrystal = v;
end});
I:Button({Title="购买宠物蛋",Callback=function()
	pcall(function()
		game:GetService("ReplicatedStorage").rEvents.openCrystalRemote:InvokeServer("openCrystal", OpenCrystal);
	end);
end});
I:Toggle({Title="自动购买选中宠物蛋",Default=false,Callback=function(s)
...
otherSection:Toggle({Title="去雾",Default=false,Callback=function(state)
	if state then
...
otherSection:Slider({Title="视野",Step=1,Value={Min=10,Max=180,Default=workspace.CurrentCamera.FieldOfView},Callback=function(FOV)
...
otherSection:Divider();
otherSection:Toggle({Title="穿墙",Default=false,Callback=function(state)
	if state then
...
otherSection:Slider({Title="飞行倍率",Step=0.1,Value={Min=1,Max=20,Default=5},Callback=function(multiplier)
	flyMultiplier = multiplier;
end});
otherSection:Toggle({Title="飞行开关",Default=false,Callback=function(bak)
	getgenv().fly = bak;
	if bak then
...
K:Button({Title="解锁全部通行证",Callback=function()
	pcall(function()
