...
function LoadingAnimation:Play(config)
    ...
    local function startPulse()
        ...
        pulseConnection = RunService.Heartbeat:Connect(function(deltaTime)
            if not isPulsing then return end
            ...
            local finalTransparency1 = isFadingOut 
                and (baseTransparency1 + (1 - baseTransparency1) * fadeOutProgress)
                or baseTransparency1
            ...
            local finalTransparency2 = isFadingOut 
                and (baseTransparency2 + (1 - baseTransparency2) * fadeOutProgress)
                or baseTransparency2
    ...
    task.spawn(function()
        ...
        local loadingTextFadeIn = TweenService:Create(LoadingText,
            TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
        ...
        local deco2FadeIn = TweenService:Create(CornerDeco2,
            TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextTransparency = 0.6}
        )
        deco1FadeIn:Play()
        ...
        local titleFadeOut = TweenService:Create(BrandTitle,
            TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextTransparency = 1}
        )
        local loadingTextFadeOut = TweenService:Create(LoadingText,
            TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextTransparency = 1}
        )
        local progressShrink = TweenService:Create(ProgressContainer,
            TweenInfo.new(0.4, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
            {Size = UDim2.new(0, 0, 0, 3 * scale)}
        )
        local progressPosTween = TweenService:Create(ProgressContainer,
            TweenInfo.new(0.4, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
            {Position = UDim2.new(0.5, 0, 0, 36 * scale)}
        )
        local deco1FadeOut = TweenService:Create(CornerDeco1,
            TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextTransparency = 1}
        )
        local deco2FadeOut = TweenService:Create(CornerDeco2,
            TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextTransparency = 1}
        )
        ...
        local readyFadeIn = TweenService:Create(CompleteText,
            TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextTransparency = 0}
        )
        readyFadeIn:Play()
        ...
        local readyFadeOut = TweenService:Create(CompleteText,
        ...
        local bgFadeOut = TweenService:Create(MainFrame,
            TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {BackgroundTransparency = 1}
        )
        bgFadeOut:Play()
